      ...
      <div>
        ...
        {products.length > 0 ? (
          products.slice(1, 4).map((item, index) => {
            // Ensure the image array is defined and has at least one item
              ...
              >
                <div className="flex items-start gap-6 text-sm">
                  ...
                  <div>
                    ...
                    <p className="mt-2">
                      Date:<span className="text-gray-400 ">31, Jul, 2024</span>
                    </p>
                  </div>
                </div>
                <div className="md:w-1/2 flex justify-between">
                  ...
                  <div className="flex justify-center mt-6 h-10 ">
                    <button className="border px-3 text-sm font-medium rounded-sm">
                      <p>Track Order</p>
                    </button>
                  </div>
                </div>
